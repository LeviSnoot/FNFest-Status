...
**This branch is for a rewrite of the project in Rust. It is not ready yet but you can follow the development process here. If you just want to run the project as is, please check the [`main`](https://github.com/LeviSnoot/FNFest-Status/tree/main) or [`legacy-python`](https://github.com/LeviSnoot/FNFest-Status/tree/legacy-python) branches.**
